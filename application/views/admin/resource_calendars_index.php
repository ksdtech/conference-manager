<section class="section--center mdl-grid">
  <div class="mdl-card">
  <?php $attributes = array('id' => 'resource_calendar_form'); ?>
  <?php form_open(site_url('admin').'/resourcecalendars/action_perform', $attributes); ?>
  <input type="hidden" id="selected_action" name="selected_action" value=""></input>
    <div class="mdl-card__title">
    <ul>
    <li><a href="<?php echo site_url('admin').'/resourcecalendars/add'; ?>">Add</a></li>
      ...
      <table class="mdl-data-table">
        ...
        <?php foreach($calendars as $calendar) { ?>
          <tr>
            ...
            <td><a href="<?php echo site_url('admin').'/resourcecalendars/edit/'.$calendar['id']; ?>">Edit</a></td>
          </tr>
        <?php } ?>
        </tbody>
      </table>
