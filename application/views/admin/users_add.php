...
<?php echo form_open(site_url('admin').'/users/add'); ?>
    ...
    <option value="6" <?php echo set_select('user_level', '6'); ?> >Teacher</option>
    <option value="9" <?php echo set_select('user_level', '9'); ?> >Administrator</option>
    </select></div>
	<div><label for="first_name">First name</label><br>
    <input type="text" id="first_name" name="first_name" value="<?php echo set_value('first_name'); ?>"></div>
	<div><label for="last_name">Last name</label><br>
    <input type="text" id="last_name" name="last_name" value="<?php echo set_value('last_name'); ?>"></div>
	<div><label for="user_email">Email address</label><br>
    <input type="text" id="user_email" name="user_email" value="<?php echo set_value('user_email'); ?>"></div>
